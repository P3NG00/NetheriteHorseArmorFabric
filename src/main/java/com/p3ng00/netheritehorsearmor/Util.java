...
public abstract class Util {
    ...
    // Config
    public static final Option<Boolean> OPTION_NETHERITE_BURN_RESIST_HORSE = new Options.BooleanOption(true, "netheriteBurnResistHorse");
    public static final Option<Boolean> OPTION_NETHERITE_BURN_RESIST_PLAYER = new Options.BooleanOption(true, "netheriteBurnResistPlayer");
    ...
    public static final Option<?>[] OPTIONS = {
            OPTION_NETHERITE_BURN_RESIST_HORSE,
            OPTION_NETHERITE_BURN_RESIST_PLAYER,
